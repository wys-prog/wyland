...
x86_64-elf-gcc -o build/WylandLinux64 "../wyland.cpp" -std=c++23  -Wall -Wextra -funroll-loops -ffreestanding

# Compile for Linux 32-bit
echo "Compiling for Linux 32-bit..."
i686-elf-gcc -m32 -o build/WylandLinux32 "../wyland.cpp" -std=c++23  -Wall -Wextra -funroll-loops -ffreestanding
