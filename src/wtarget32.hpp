...
private:
  ...
  void sldlib() {
    ...
    for (uint32_t i = 0; i < len; i++) lib += memory[mybeg+i];
  ...
  void sldlcfun() {
    ...
    for (uint32_t i = 0; i < len; i++) func += memory[mybeg+i];
  ...
  void sstartt() {
    ...
    // TODO !! (linked funcs)
    wlinkfns funcs{};
    c->init(beg, end, false, beg+1, &funcs, beg);
  ...
  syscall_t syscalls[SYSCALL_COUNT] = {
    &corewtarg32::swritec,
    &corewtarg32::swritec_stderr,
    &corewtarg32::sreadc,
    &corewtarg32::scsystem,
    &corewtarg32::sldlib,
    &corewtarg32::sstartt,
    &corewtarg32::spseg,
    &corewtarg32::sreads, 
    /* New */
    &corewtarg32::sldlcfun, 
    &corewtarg32::suldlib,
    &corewtarg32::scfun,
  };
